...
/**
 * Converts a Cloudinary URL (from API response or upload result) into a
 * proxied backend URL, so the browser never directly contacts Cloudinary.
 *
 * @param {string|null|undefined} cloudinaryUrl - The raw Cloudinary URL stored in the DB
 *   or returned by the upload endpoint.
